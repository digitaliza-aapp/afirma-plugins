...
| [**`MarcarPrimeraFirma`**](https://github.com/digitaliza-aapp/afirma-plugins/blob/master/afirma-simple-plugin-marcarprimerafirma/src/main/resources/es/gob/afirma/plugin/marcarprimerafirma/Plugin_MarcarPrimeraFirma_v00r01.pdf?raw=yes)| [**00.01Beta02**](https://github.com/digitaliza-aapp/afirma-plugins/blob/master/plugins/MarcarPrimeraFirma/00.01Beta02/afirma-ui-simpleafirma-plugin-marcarprimerafirma_v00r01Beta02.jar?raw=yes)| Añadir marca de agua en la primera firma (Firma masiva) |
| [**`TablaHuellas`**](https://github.com/digitaliza-aapp/afirma-plugins/blob/master/afirma-simple-plugin-tablahuellas/src/main/resources/es/gob/afirma/plugin/tablahuellas/Ejemplo_Uso_v00r00.pdf?raw=yes)| [**00.01Beta**](https://github.com/digitaliza-aapp/afirma-plugins/blob/master/plugins/TablaHuellas/00.01Beta/afirma-ui-simpleafirma-plugin-tablahuellas_v00r01Beta01.jar?raw=yes)| Crear indice con huellas digitales para un grupo de documentos (expediente) [**`Ejemplo de uso (Indice con 3 documentos)`**](https://github.com/digitaliza-aapp/afirma-plugins/blob/master/afirma-simple-plugin-tablahuellas/src/main/resources/es/gob/afirma/plugin/tablahuellas/Indice_Documentos_v00r00_signed.pdf?raw=yes)|
